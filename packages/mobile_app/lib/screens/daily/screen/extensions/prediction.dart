...
extension DailyScreenPredictionMethods on _DailyScreenState {
  String getPrediction() {
    final propheciesSum = StaticProvider.prophecyUtil.current.sum;
    final prophecies = StaticProvider.prophecyUtil.current;
    ProphecyType type;
    String result;
  ...
  String getPredictionByType({@required ProphecyType type}) {
    if (StaticProvider.prophecyUtil.current[type].value > _isPositive)
